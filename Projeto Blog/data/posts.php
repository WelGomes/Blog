<?php
    ...
    $posts = [
        [
            ...
            "description" => "Neste post você vai aprender tudo que precisa para ser um bom programador",
        ...
        [
            "id" => 4,
            "title" => "Programador em C",
            "description" => "Neste post vai aprender tudo sobre a linguagem C",
            "tags" => ["linguagem C", "OOP", "C#"],
            "img" => "prog-4.jpg"
        ],
    ]
